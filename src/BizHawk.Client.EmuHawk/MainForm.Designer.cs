...
namespace BizHawk.Client.EmuHawk
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.SaveConfigOnClose = new System.Windows.Forms.ToolStripMenuItem();
			...
			// MainformMenu
			//
			this.MainformMenu.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.FileSubMenu, this.EmulationSubMenu, this.ViewSubMenu, this.ConfigSubMenu, this.ToolsSubMenu, this.NESSubMenu, this.TI83SubMenu, this.A7800SubMenu, this.GBSubMenu, this.PSXSubMenu, this.SNESSubMenu, this.ColecoSubMenu, this.N64SubMenu, this.Ares64SubMenu, this.GBLSubMenu, this.AppleSubMenu, this.C64SubMenu, this.IntvSubMenu, this.zXSpectrumToolStripMenuItem, this.GenericCoreSubMenu, this.amstradCPCToolStripMenuItem, this.HelpSubMenu });
			...
			// FileSubMenu
			//
			this.FileSubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.OpenRomMenuItem, this.RecentRomSubMenu, this.OpenAdvancedMenuItem, this.CloseRomMenuItem, this.toolStripMenuItem1, this.SaveSampleMenuItem, this.LoadSampleMenuItem, this.SaveStateSubMenu, this.LoadStateSubMenu, this.SaveSlotSubMenu, this.SaveRAMSubMenu, this.toolStripMenuItem2, this.MovieSubMenu, this.AVSubMenu, this.ScreenshotSubMenu, this.toolStripSeparator4, this.ExitMenuItem });
			...
			// AVSubMenu
			//
			this.AVSubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.RecordAVMenuItem, this.ConfigAndRecordAVMenuItem, this.StopAVIMenuItem, this.toolStripSeparator19, this.CaptureOSDMenuItem, this.CaptureLuaMenuItem, this.SynclessRecordingMenuItem });
			...
			this.CaptureLuaMenuItem.Size = new System.Drawing.Size(274, 24);
			...
			// EmulationSubMenu
			//
			this.EmulationSubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.PauseMenuItem, this.RebootCoreMenuItem, this.toolStripSeparator1, this.SoftResetMenuItem, this.HardResetMenuItem, this.EmulatorMenuSeparator2, this.LoadedCoreNameMenuItem });
			...
			// SaveConfigOnClose
			//
			this.SaveConfigOnClose.Name = "SaveConfigOnClose";
			this.SaveConfigOnClose.Size = new System.Drawing.Size(218, 24);
			this.SaveConfigOnClose.Text = "Save Config on Close";
			this.SaveConfigOnClose.Click += new System.EventHandler(this.SaveConfigOnCloseToolStripMenuItem_Click);
			//
			// ToolsSubMenu
			//
			...
			//
			this.RetroAchievementsMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.StartRetroAchievementsMenuItem });
			...
			// NESSubMenu
			//
			this.NESSubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.NESPPUViewerMenuItem, this.NESNametableViewerMenuItem, this.MusicRipperMenuItem, this.toolStripSeparator17, this.NesControllerSettingsMenuItem, this.NESGraphicSettingsMenuItem, this.NESSoundChannelsMenuItem, this.VSSettingsMenuItem, this.MovieSettingsMenuItem, this.toolStripSeparator22, this.FDSControlsMenuItem, this.VSControlsMenuItem, this.BarcodeReaderMenuItem });
			...
			// TI83SubMenu
			//
			this.TI83SubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.KeypadMenuItem, this.LoadTIFileMenuItem, this.toolStripSeparator13, this.paletteToolStripMenuItem });
			...
			// GBSubMenu
			//
			this.GBSubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.GBcoreSettingsToolStripMenuItem, this.SameBoyColorChooserMenuItem, this.toolStripSeparator28, this.GBGPUViewerMenuItem, this.GBPrinterViewerMenuItem });
			...
			// SNESSubMenu
			//
			this.SNESSubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.SNESControllerConfigurationMenuItem, this.toolStripSeparator18, this.SnesGfxDebuggerMenuItem, this.SnesOptionsMenuItem });
			...
			// Ares64SubMenu
			//
			this.Ares64SubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Ares64SettingsMenuItem, this.Ares64CircularAnalogRangeMenuItem });
			...
			// GBLSubMenu
			//
			this.GBLSubMenu.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.GBLsettingsToolStripMenuItem });
			...
			//
			this.zXSpectrumToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.ZXSpectrumCoreEmulationSettingsMenuItem, this.ZXSpectrumControllerConfigurationMenuItem, this.ZXSpectrumAudioSettingsMenuItem, this.ZXSpectrumNonSyncSettingsMenuItem, this.ZXSpectrumMediaMenuItem });
			...
			//
			this.amstradCPCToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.amstradCPCCoreEmulationSettingsToolStripMenuItem, this.AmstradCPCAudioSettingsToolStripMenuItem, this.AmstradCPCNonSyncSettingsToolStripMenuItem, this.AmstradCPCMediaToolStripMenuItem });
			...
			this.MainStatusBar.Location = new System.Drawing.Point(0, 383);
			...
			this.DumpStatusButton.Size = new System.Drawing.Size(4, 23);
			...
			this.PlayRecordStatusButton.Size = new System.Drawing.Size(4, 23);
			...
			this.PauseStatusButton.Size = new System.Drawing.Size(4, 23);
			...
			this.MainFormContextMenu.Size = new System.Drawing.Size(257, 532);
		...
		private System.Windows.Forms.ToolStripMenuItem SaveConfigOnClose;
		...
		private BizHawk.WinForms.Controls.MenuStripEx MainformMenu;
